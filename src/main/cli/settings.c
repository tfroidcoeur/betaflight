...
// PG_LED_STRIP_CONFIG
    ...
    { "ledstrip_preset_default",    VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, LEDSTRIP_PRESET_COUNT - 1 }, PG_LED_STRIP_CONFIG, offsetof(ledStripConfig_t, ledstrip_preset_default) },
